          ...
          <div className="row g-3 row-deck">
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="card overflow-hidden">
                <div className="card-body">
                  ...
                  <div className="mb-2 text-uppercase">NEW EMPLOYEE</div>
                  <div>
              ...
              <div className="card overflow-hidden">
                <div className="card-body">
                  ...
                  <div>
                    ...
                    <span className="small text-muted">
                      <i className="fa fa-level-up"></i> 78%
                    </span>
                  </div>
                  <small className="text-muted">Analytics for last week</small>
                </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="card overflow-hidden">
                <div className="card-body">
                  ...
                  <div className="mb-2 text-uppercase">NEW LEADS</div>
                  <div>
                    <span className="h4">125</span>{" "}
                    <span className="small text-muted">
                      <i className="fa fa-level-up"></i> 55%
                    </span>
                  </div>
                  <small className="text-muted">Analytics for last week</small>
                </div>
                ...
                <div className="card-body d-flex align-items-center justify-content-center">
                  <div>
                    ...
                    <p className="card-text fs-6 mb-5">
                      ...
                      Luno Admin. It includes tons of <strong>Widgets</strong>,{" "}
            ...
            <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6">
              <div className="card">
                ...
                <div className="card-body">
                  <div>
                    Available BTC <a href="crypto/index.html">View Account</a>
                  </div>
                  <h3>0.0386245 BTC</h3>
                  <div className="py-4">
                  ...
                  <ul className="list-unstyled">
                    <li className="d-flex py-2 mb-2">
                      <div className="avatar rounded no-thumbnail">
                        <i className="fa fa-file-zip-o fa-lg"></i>
                      </div>
                ...
                <div className="table-responsive border-top">
                  <table className="table card-table table-nowrap mb-0">
                    <tbody>
                      <tr>
                        <td>
                          <i className="fa fa-circle me-2 chart-text-color1"></i>
                          Gross value
                        </td>
                        <td>$3,500.71</td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <i className="fa fa-circle me-2 chart-text-color2"></i>
                      ...
                      <tr>
                        <td>
                          <i className="fa fa-circle me-2 chart-text-color3"></i>
                      ...
                      <tr>
                        <td>
                          <i className="fa fa-circle me-2"></i>Other
                        </td>
                        <td>32</td>
                        <td>
