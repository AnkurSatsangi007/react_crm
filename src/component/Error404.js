        ...
        <div className="row g-3">
          <div className="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
            <div style={{maxWidth: "25rem"}}>
              ...
              <div className="mb-2">
                <Link to="#" className="me-3 color-600">Home</Link>
                <Link to="#" className="me-3 color-600">About Us</Link>
                <Link to="#" className="me-3 color-600">FAQs</Link>
              </div>
              <div>
                <Link to="#" className="me-3 color-400"><i className="fa fa-facebook-square fa-lg"></i></Link>
                <Link to="#" className="me-3 color-400"><i className="fa fa-github-square fa-lg"></i></Link>
                <Link to="#" className="me-3 color-400"><i className="fa fa-linkedin-square fa-lg"></i></Link>
                <Link to="#" className="me-3 color-400"><i className="fa fa-twitter-square fa-lg"></i></Link>
              </div>
            </div>
          </div>
            ...
            <div className="card shadow-sm w-100 p-4 p-md-5" style={{maxWidth: "32rem"}}>
              ...
              <form className="row g-3">
                <div className="col-12 text-center mb-4">
                  <img src="assets/img/auth-404.svg" className="w240 mb-4" alt="" />
                  <h1 className="display-1">404</h1>
                  <h5>OOP! PAGE NOT FOUND</h5>
                  <span className="text-muted">Sorry, the page you're looking for doesn;t exist. if you think something is brlken, report a problem.</span>
                </div>
                <div className="col-12 text-center">
                  <Link to="/DashBoard" title="" className="btn btn-lg btn-block btn-dark lift text-uppercase">Back to Home</Link>
                </div>
              </form>
              {/* <!-- End Form --> */}
            </div>
