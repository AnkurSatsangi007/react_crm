            ...
            <div className="card shadow-sm w-100 p-4 p-md-5" style={{maxWidth: "32rem"}}>
              ...
              <form className="row g-3">
                <div className="col-12 text-center mb-4">
                  <img src="assets/img/auth-500.svg" className="w240 mb-4" alt="" />
                  <h1 className="display-1">500</h1>
                  <h5>Internal Server Error</h5>
                  <span className="text-muted">The server has been deserted for a while. Please be patient or try again later.</span>
                </div>
